...
export default createStore({
    ...
    apartments: [
      {
        ...
        minImage: "s121_small.jpg",
        images: ["s121.jpg", "s122.jpg", "s123.jpg", "s124.jpg", "s125.jpg","s126.jpg","s127.jpg","s128.jpg","s129.jpg"],
        price: 2500,
      ...
      },
      {
        id: 2,
        name: "1-комнатная квартира в центре Тосно",
        minImage: "g51_small.jpg",
        images: ["g51.jpg", "g52.jpg", "g53.jpg", "g54.jpg", "g55.jpg","g56.jpg"],
        price: 2500,
  ...
  mutations: {
    setPrices(state, prices) {
      for (let i = 0; i < prices.length; i++) {
        let apart = state.apartments.find((el) => (el.id === prices[i].id));
  ...
  actions: {
    getPrices() {
      axios.get("apartmentsPrices.json").then((res) => {
        this.commit('setPrices', res.data)
